...
var file = path.resolve(__dirname, '../example/error.gs');
var multilineFile = path.resolve(__dirname, '../example/multiline_error.gs');
var transform = path.join(__dirname, '../no-debug');
...
test('transform error', function (t) {
    ...
    b.bundle(function (error) {
        ...
        t.equal(error.column, 13, "error should be on column 13");
    });
});
